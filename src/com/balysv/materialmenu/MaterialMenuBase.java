...
public abstract class MaterialMenuBase implements MaterialMenu {
	 ...
	 * {@link #animatePressedState(com.balysv.materialmenu.MaterialMenuDrawable.IconState)}
	 * 
	 * @param neverDrawTouch
	...
	/**
	 * Call from
	 * {@link android.app.Activity#onSaveInstanceState(android.os.Bundle)} to
	...
	/**
	 * Call from {@link android.app.Activity#onPostCreate(android.os.Bundle)} to
	 * restore icon state
	 * 
	 * @param state
	 *            state
